...
echo '<h2 style="margin-top: 20px;">Test Dificil</h2>';

if (!isset($_POST["quiz"])) {
} else if (strtoupper($_POST["quiz"]) == strtoupper($quiz["dificil"][$_SESSION["i"]]["respuesta"])) {
   //correcto
...
echo '
   <div class="mb-3">
      <label for="quiz" class="form-label">' . $quiz["dificil"][$_SESSION["i"]]["pregunta"] . '</label>
