...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="confirmacion.php" class="mx-auto" style="max-width: 600px;">
        <?php
            if(!isset($_GET['id'])){
                echo '
                ...
                echo '
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="titulo" name="titulo" value="'.$_SESSION['libros'][$_GET['id']]["titulo"].'" placeholder="Título" required>
                        <label for="titulo">Título</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="autor" name="autor" value="'.$_SESSION['libros'][$_GET['id']]["autor"].'" placeholder="Autor" required>
                        <label for="autor">Autor</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="imagen" name="imagen" value="'.$_SESSION['libros'][$_GET['id']]["imagen"].'" placeholder="URL de la Imagen">
                        <label for="imagen">URL de la Imagen</label>
                    </div>
                    <div class="form-floating mb-4">
                        <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Descripción" style="height: 150px;">'.$_SESSION['libros'][$_GET['id']]["descripcion"].'</textarea>
                        <label for="descripcion">Descripción</label>
                    </div>
                    <div class="d-grid">
